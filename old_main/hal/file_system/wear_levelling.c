...
/* https://github.com/espressif/esp-idf/blob/v5.1/examples/storage/wear_levelling/main/wear_levelling_example_main.c */
...
void wear_levelling_init()
{
    ...
    // //Open file for reading
    // err = s_example_read_file("/spiflash/jiji.txt");
    // if (err != ESP_OK) {
    //     return;
    // }
